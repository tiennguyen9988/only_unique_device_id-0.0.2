...
//        // If a user upgrades software or roots their device, there will be a duplicate entry
        ...
        try {
            ...
            return new UUID(Secure.getString(context.getContentResolver(),
                    Secure.ANDROID_ID).hashCode(), serial.hashCode()).toString();
        } catch (Exception exception) {
            // String needs to be initialized
            serial = android.provider.Settings.Secure.ANDROID_ID;
        }
